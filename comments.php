		...
		<?php endif; // Check for have_comments(). ?>
			...
			<?php
				...
				<?php comment_form( array(
					...
					'logged_in_as' 			=> '<p class="logged-in-as">' . sprintf( __( 'Comment as <a href="%1$s">%2$s</a> | <a href="%3$s" title="Log out of this account">Log out?</a>' ), admin_url( 'profile.php' ), $user_identity, wp_logout_url( apply_filters( 'the_permalink', get_permalink( ) ) ) ) . '</p>',
